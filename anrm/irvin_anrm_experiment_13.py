...
"""
    ...
    5) RIP1 Hypothesis 2: RIP1-unmod =! RIP1-deub
        5a) RIP1 deubiquitination the secondary complex
        5b) TRADD can bind RIP1-unmod as well as RIP1-deub
    6) Bid-po4 not sequesters RIP1
    7) C3 inhibits MLKL
...
irvin.TRADD_RIP1unmod_Hypothesis_2()#5b
