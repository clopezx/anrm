...
4) RIP1 Hypothesis 1: RIP1-unmod = RIP1-deub
5) TRADD can bind RIP1-unmod
...
"""
    ...
    5) RIP1 Hypothesis 2: RIP1-unmod =! RIP1-deub
        5a) RIP deubiquitination in 2o complex
        5b) TRADD cannot bind RIP1-unmod as well as RIP1-deub
    6) Bid-po4 sequesters RIP1
    7) C3 inhibits MLKL
